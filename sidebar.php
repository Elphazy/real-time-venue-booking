                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">RTV</span><span class="font-size-xl text-primary">BS</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                <li class="open">
                                    <a href="dashboard.php"><i class="si si-cup"></i><span class="sidebar-mini-hide">Home</span></a>
                                   
                                </li>
                              
                                <li class="nav-main-heading"><span class="sidebar-mini-visible">UI</span><span class="sidebar-mini-hidden"></span></li>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-puzzle"></i><span class="sidebar-mini-hide"></span>Reservation</a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-energy"></i><span class="sidebar-mini-hide">Halls</span></a>
                                    <ul>
                                        <li>
                                            <a href="room.php">Halls Available</a>
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="dashboard.php"><i class="si si-user"></i><span class="sidebar-mini-hide">My Bookings</span></a>
