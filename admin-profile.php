...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Real Time Venue Booking System -Customer Profile</title>
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Customer Profile</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
...
{               ?>
                                    <form method="post">
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-username">Customer Name:</label>
                                            <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            <label class="col-12" for="register1-password">Customer Registration Date:</label>
                                            <div class="col-12">
