	...
	<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
		...
		class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand" >Real Time Venue Booking System</a>
			</div>
		</div>
	</nav>	
	<ul id = "menu">
	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<p>The tariff is for the hall only and is exclusive of any government taxes applicable Meals and other services are available at extra cost . To know your hall tariff, please contact the Duty Manager, guest registration forms must be signed on arrivals. </p>
				<br />
				...
				<p>Please present your ID card, Passport or Temporary Residence Card upon Check-in. By Law visitors must present personal documents for hall records. These documents will be returned upon departure.</p>
				<br />
				<strong><h4 style = "color:#ff0000;">5. Departure</h4></strong>
				<p>Check out time is ( mention your checkout time here ) please inform the reception if you wish to retain your hall beyond this time. Extension will be given depending on the availability . If the hall is available, normal tariff will be charged. On failure of the guest to vacate the hall on expiry or period the management shall have the right to remove the guest and his/her belongings from the hall occupied by the Guest.</p>
				<br />
				...
				<p>The guest will be held responsible for any loss or damage to the management property caused by themselves, their guests or any person for whom they are responsible.</p>
				<br />
				<strong><h4 style = "color:#ff0000;">10. Management's Rights</h4></strong>
				<p>It is agreed that the guest will conduct him/ herself in a respectable manner and will not cause any nuisance or annoyance within the hall premise.</p>
				<br />
